...
def get_project_by_title(title):
    ...
    print(f"Project title: {title}, Project description: {description}")
...
def get_grade_by_github_title(github, title):
    ...
    print(f'The grade for {title} by {github} is {grade}')
...
def assign_grade(github, title, grade):
    ...
    print(f" Grade: {grade} was successfully updated for {github} and {title}")
